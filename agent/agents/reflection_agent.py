...
class ReflectionAgent(Agent):
    ...
    async def run(self, input_text: str) -> str:
        ...
        initial_result = await self._get_llm_response(initial_prompt)
        ...
        for i in range(self.max_iterations):
            ...
            refined_result = await self._get_llm_response(refine_prompt)
    ...
    async def _get_llm_response(self, prompt: str) -> str:
        ...
        return await self.llm.invoke(messages) or ""
